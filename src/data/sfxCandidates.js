/**
 * SFX Candidate Manifest for Sound Test
...
export function getSfxCandidateById(id) {
  return SFX_CANDIDATES.find(c => c.id === id) || null;
}

export function getSfxCandidatesByGroup(group) {
  return SFX_CANDIDATES.filter(c => c.group === group);
}
