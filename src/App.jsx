...
export default function App() {
  ...
  if (screen === 'START') {
    ...
    const prologuePages = [
      "ç ‚æ¼ ã®è¡—ãEã‚°ãƒªãƒãƒ«ã€‚ãã®å–§é¨’ã‚’æŠœã‘ãŸè·¯åœ°è£ã«ã€å°ã•ãªéŒ¬é‡‘è¡“åº—ã€æ˜Ÿç“¶å ‚ã€ãŒã‚ã‚‹ã€E",
      "è‹¥åº—ä¸»ãƒŠãEãƒE‚£ãƒ«ã¯ã€å®¢ã®ä¾é ¼ã«åˆã†å“ã‚’è¦‹æ¥µã‚ãªãŒã‚‰ã€å”åŠ›è€E¨ã®ç¸ã‚’å°‘ã—ãšã¤è‚²ã¦ã¦ãEã€E",
    ];
    mainContent = (
      <div style={{ ...containerStyle, position: 'relative' }}>
        ...
        <div style={{ zIndex: 2, position: 'relative', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          {renderAudioToggle()}
          <h1 style={{ ...titleStyle, marginBottom: '30px' }}>¯•r“°‚Ìn‚Ü‚è</h1>
