...
function App() {
  ...
  const renderUtilityHeader = (title, action = handleBackToTitle, right = null) => /* @__PURE__ */ React.createElement("div", { style: utilityHeaderStyle }, /* @__PURE__ */ React.createElement("button", { onClick: action, style: utilityBackButtonStyle }, "戻る"), /* @__PURE__ */ React.createElement("div", { style: {
    color: THEME.sand,
    fontWeight: "bold",
    fontSize: "0.95em",
    textAlign: "center",
