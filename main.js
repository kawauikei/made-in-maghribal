...
function App() {
  ...
  const renderMenuModal = () => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { ...cardStyle, maxWidth: "300px", background: "#fff", padding: "25px", borderRadius: "12px" } }, /* @__PURE__ */ React.createElement("h2", { style: { margin: "0 0 20px 0", color: THEME.nightBlue, textAlign: "center", fontSize: "1.4em" } }, "設定"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 0", borderBottom: "1px solid #eee" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: "1em", color: THEME.textDark, fontWeight: "bold" } }, "BGM: ", isAudioEnabled ? "ON" : "OFF"), /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: () => {
            audioEngine.playSfx("uiTapBottle");
      ...
      )), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 0", borderBottom: "1px solid #eee" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: "0.9em", color: "#999" } }, "音量（準備中）"), /* @__PURE__ */ React.createElement("div", { style: { width: "80px", height: "6px", background: "#eee", borderRadius: "3px" } }, /* @__PURE__ */ React.createElement("div", { style: { width: "70%", height: "100%", background: THEME.brass, borderRadius: "3px" } }))), /* @__PURE__ */ React.createElement("div", { style: { marginTop: "25px", display: "flex", flexDirection: "column", gap: "12px" } }, /* @__PURE__ */ React.createElement(
        "button",
        {
  ...
  if (screen === "START") {
    ...
    mainContent = /* @__PURE__ */ React.createElement("div", { style: { ...containerStyle, position: "relative" } }, renderThemeStyles(), renderBackground(screen), /* @__PURE__ */ React.createElement("div", { style: { zIndex: 2, position: "relative", width: "100%", display: "flex", flexDirection: "column", alignItems: "center" } }, renderAudioToggle(), /* @__PURE__ */ React.createElement("h1", { style: titleStyle }, workshopState.day, "日目：", SHOP.name, "の朝"), /* @__PURE__ */ React.createElement("div", { style: { ...cardStyle, background: "transparent", boxShadow: "none", padding: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "15px", alignItems: "flex-start", marginBottom: "20px" } }, /* @__PURE__ */ React.createElement(HeroineDisplay, { heroine: activeHeroine, type: "face", size: "small", expression: "normal" }), /* @__PURE__ */ React.createElement(
      VNBox,
      {
    ...
    )), /* @__PURE__ */ React.createElement("div", { style: { ...narrativeBoxStyle, background: "rgba(0,0,0,0.4)", color: "#fff", borderLeft: `4px solid ${THEME.brass}` } }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 8px 0" } }, "朝の光が差し込む店内で、", activeHeroine.name, "は手際よく準備を手伝ってくれている。"), /* @__PURE__ */ React.createElement("p", { style: { margin: 0 } }, "今日の客人は、どんな品を求めてやってくるだろうか。")), /* @__PURE__ */ React.createElement("button", { onClick: handleBeginService, style: { ...buttonStyle, width: "100%", maxWidth: "240px", marginTop: "20px" } }, "接客を始める"))));
    ...
    ), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "1.1em", color: activeHeroine.themeColor, fontWeight: "bold" } }, activeHeroine.name, "との絆 +", lastAffectionGain)), /* @__PURE__ */ React.createElement("div", { style: {
      display: "grid",
    ...
    mainContent = /* @__PURE__ */ React.createElement("div", { style: containerStyle }, renderThemeStyles(), /* @__PURE__ */ React.createElement("button", { onClick: handleBackToTitle, style: { ...utilityBackButtonStyle, position: "absolute", top: "6px", left: "8px", zIndex: 50 } }, "Back"), /* @__PURE__ */ React.createElement("h1", { style: { ...titleStyle, marginTop: "36px", marginBottom: "8px" } }, "Visual Asset Test"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", width: "100%", marginBottom: "8px" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setVisualTestMode("background"), style: { ...utilityBackButtonStyle, width: "100%", background: visualTestMode === "background" ? THEME.brass : THEME.nightBlue, color: visualTestMode === "background" ? THEME.textDark : THEME.sand } }, "Background"), /* @__PURE__ */ React.createElement("button", { onClick: () => setVisualTestMode("still"), style: { ...utilityBackButtonStyle, width: "100%", background: visualTestMode === "still" ? THEME.brass : THEME.nightBlue, color: visualTestMode === "still" ? THEME.textDark : THEME.sand } }, "Still")), /* @__PURE__ */ React.createElement("div", { style: { ...cardStyle, maxWidth: "800px", maxHeight: "700px", overflowY: "auto", paddingTop: "10px" } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "12px", display: visualTestMode === "background" ? "block" : "none" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" } }, /* @__PURE__ */ React.createElement("h3", { style: { color: "#aaa", fontSize: "0.9em", margin: 0 } }, "Background: ", bg.label, " (", bg.id, ")"), /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    ))), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "12px", display: visualTestMode === "still" ? "block" : "none" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" } }, /* @__PURE__ */ React.createElement("h3", { style: { color: "#aaa", fontSize: "0.9em", margin: 0 } }, "Still: ", still.label, " (", still.id, ")"), /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      width: "100%",
      zIndex: 10
    } }, /* @__PURE__ */ React.createElement("button", { onClick: handleBackToTitle, style: { ...buttonStyle, margin: 0, width: "100%" } }, "タイトルへ戻る"))));
    ...
    mainContent = /* @__PURE__ */ React.createElement("div", { style: { ...containerStyle, padding: 0 } }, renderThemeStyles(), renderAudioToggle(), renderUtilityHeader("Memories"), /* @__PURE__ */ React.createElement("h1", { style: { ...titleStyle, display: "none" } }, "思い出の記録"), /* @__PURE__ */ React.createElement("div", { style: { ...cardStyle, maxWidth: "800px", flex: 1, minHeight: 0, display: "flex", flexDirection: "column", margin: "0 8px 8px", width: "calc(100% - 16px)", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minHeight: 0, overflowY: "auto", paddingRight: "2px" } }, seenEvents.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { padding: "60px 20px", color: "#666", fontStyle: "italic", textAlign: "center" } }, /* @__PURE__ */ React.createElement("p", null, "まだ記された思い出はありません。"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: "0.9em", marginTop: "10px" } }, "日々の仕事を通じて、彼女たちとの絆を深めましょう。")) : /* @__PURE__ */ React.createElement("div", { style: { textAlign: "left" } }, HEROINES.map((heroine) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: heroine.id, style: { marginBottom: "30px" } }, /* @__PURE__ */ React.createElement("div", { style: {
        ...
        /* @__PURE__ */ React.createElement("span", { style: { fontSize: "0.8em", color: THEME.brassDark } }, "閲覧する →")
      ))));
    ...
    mainContent = /* @__PURE__ */ React.createElement("div", { style: containerStyle }, renderThemeStyles(), renderAudioToggle(), /* @__PURE__ */ React.createElement("h1", { style: { ...titleStyle, marginBottom: "20px" } }, "誰との縁を深める？"), /* @__PURE__ */ React.createElement("div", { style: {
      display: "flex",
      justifyContent: "center",
      gap: "20px",
      marginBottom: "20px",
    ...
    mainContent = /* @__PURE__ */ React.createElement("div", { style: containerStyle }, renderThemeStyles(), renderAudioToggle(), /* @__PURE__ */ React.createElement("header", { style: {
      ...
      gap: "20px"
    } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: "0.9em" } }, "鑑定依頼 ", session.currentIndex + 1, " / ", session.questions.length), /* @__PURE__ */ React.createElement("span", { style: { fontWeight: "bold", color: THEME.brass } }, "報酬見込: ", session.score, " G")), /* @__PURE__ */ React.createElement("div", { style: { ...cardStyle, maxWidth: "800px", marginTop: "10px" } }, /* @__PURE__ */ React.createElement("div", { style: { ...customerStyle, marginBottom: "30px" } }, /* @__PURE__ */ React.createElement("div", { style: {
      ...bubbleStyle,
      background: "#fff",
      color: "#333",
...
function VNBox({ text, speaker, themeColor, onComplete, speed = 30, skip = false }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: "1.05em", lineHeight: "1.6", minHeight: "1.5em" } }, displayText, !isComplete && /* @__PURE__ */ React.createElement("span", { style: { animation: "vn-blink 1s infinite", marginLeft: "2px" } }, "|")),
